...
class TinySSD(nn.Module):
    def __init__(self, num_classes, **kwargs):
        ...
        for i in range(5):
            ...
            setattr(self, f'cls_{i}', class_predictor(idx_to_in_channels[i],
...
X = torchvision.io.read_image('C:\\Users\\Anthony\\Desktop\\DL\\d2l-zh-master\\img\\banana.jpg').unsqueeze(0).float()
